...
function Tracks({host,onError}){
  ...
  return isTrackReference(track)?<VideoTrack trackRef={track} style={styles.video} mirror={host} objectFit="cover"/>:<View style={styles.video}><Text style={s.text}>Camera track is unavailable.</Text></View>;
}
